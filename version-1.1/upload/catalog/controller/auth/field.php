...
/////load
		$this->load->language('oauth/field');
...
/////end load
		...
		$data['heading_title'] = $this->language->get('head_title');
		$data['button_back'] = $this->language->get('button_back');
		$data['button_continue'] = $this->language->get('button_continue');
		$data['entry_firstname'] = $this->language->get('input_name');
		$data['entry_lastname'] = $this->language->get('input_lastname');
		$data['entry_email'] = $this->language->get('input_email');
		$data['entry_telephone'] = $this->language->get('input_telephone');
		$data['entry_password'] = $this->language->get('input_password');
